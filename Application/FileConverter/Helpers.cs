...
namespace FileConverter
{
    ...
    public static class Helpers
    {
        ...
        /// </summary>
        public static string NormalizeExtension(string extensionOrPathExtension)
        {
            return Core.FileExtension.Normalize(extensionOrPathExtension);
        }
        ...
        {
            return Core.FileExtension.FromPath(filePath);
        }
