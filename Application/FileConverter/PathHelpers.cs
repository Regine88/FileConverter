...
namespace FileConverter
{
    ...
    public static class PathHelpers
    {
        ...
        public static string GenerateFilePathFromTemplate(string inputFilePath, OutputType outputFileExtension, string outputFilePathTemplate, int numberIndex, int numberMax)
        {
            ...
            string inputExtension = Helpers.GetFileExtension(inputFilePath);
            string inputPathWithoutExtension = string.IsNullOrEmpty(inputExtension)
                ? inputFilePath
                : inputFilePath.Substring(0, inputFilePath.Length - inputExtension.Length - 1);
