...
namespace FileConverter.ConversionJobs
{
    public static class ConversionJobFactory
    {
        ...
        {
            // Safe extension handling: empty/missing extensions must not throw and must not break batch registration.
            string inputFileExtension = Helpers.GetFileExtension(inputFilePath);
